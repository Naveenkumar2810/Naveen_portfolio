...
const Contact = () => {
  ...
  const form_submit =(e)=>{
    ...
    if (allKeysTrue){
      // emailjs.sendForm('service_mev3lbp','template_bk59usn',e.target,'1Ypq9VSuZJ_FuCQFe')
  ...
  return (
    <div className='w-full min-h-full flex flex-col justify-center items-center mt-5 md:mt-0'>
        <h1 className='w-full md:w-1/2 text-4xl text-cus-yell items-center '>Contact Form</h1>
        <form onSubmit={(e)=> form_submit(e)}  className=' w-full md:w-1/2 h-full md:h-1/2 justify-center text-white-1 p-5 px-8 flex flex-row flex-wrap md:gap-2 gap-5 '>
            <input onChange={(e)=>Check_input(e)} name='fname' className='w-full md:w-72 bg-highlight1 p-5 border-b-[1px] border-br rounded-lg focus:outline-none focus:border-cus-yell' type='text' placeholder='Full Name'/>
            <input onChange={(e)=>Check_input(e)} name='email' className='w-full md:w-1/2 bg-highlight1 p-5 border-b-[1px] border-br rounded-lg focus:outline-none focus:border-cus-yell' type='Email' placeholder='Email'/>
            <input onChange={(e)=>Check_input(e)} name='message' className='w-full md:w-full bg-highlight1 p-6 border-b-[1px] border-br rounded-lg h-32 focus:outline-none focus:border-cus-yell md:mt-2' type='text' placeholder='Message'/>
            <div className='phone w-full h-30 p-2 flex justify-center md:justify-start'>
              <span className='w-1/2 md:w-1/4 h-16 p-1 rounded-lg text-cus-yell  flex justify-center items-center gap-4  bg-icon shadow-icon-sd'>
